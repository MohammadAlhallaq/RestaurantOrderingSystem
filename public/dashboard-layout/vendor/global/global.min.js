...
dezSettings.prototype.manageSidebarStyle = function() {
    ...
    switch(this.sidebarStyle) {
        ...
        case "modern":
            ...
            break;
        case "icons-hover":
            body.attr("data-sidebar-style", "icons-hover");
			...
			$('.deznav').hover(function() {
				 ...
				 if(body.attr('data-sidebar-style') === 'icons-hover') { $('#main-wrapper').addClass('iconhover-toggle'); }

				currentBodyLayout = jQuery('body').attr('data-layout');
				currentSidebarStyle = jQuery('body').attr('data-sidebar-style');

                if(currentBodyLayout === 'vertical' && currentSidebarStyle === 'icons-hover'){ $('.metismenu .mm-active ul').addClass('mm-show'); }

			}, function() {

				 if(body.attr('data-sidebar-style') === 'icons-hover') { $('#main-wrapper').removeClass('iconhover-toggle'); }

				currentBodyLayout = jQuery('body').attr('data-layout');
				currentSidebarStyle = jQuery('body').attr('data-sidebar-style');

				if(currentBodyLayout === 'vertical' && currentSidebarStyle === 'icons-hover'){ $('.metismenu .mm-active ul').removeClass('mm-show'); }
            }); */
            break;
        case "overlay":
