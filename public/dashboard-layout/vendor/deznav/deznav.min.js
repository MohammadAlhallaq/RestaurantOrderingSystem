!function (a, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t(require("jquery")) : "function" == typeof define && define.amd ? define(["jquery"], t) : a.metisMenu = t(a.jQuery)
}(this, function (a) {
    "use strict";
    ...
    function t(a) {
        for (var t = 1; t < arguments.length; t++) {
            ...
            "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(e).filter(function (a) {
                ...
                var r, i, o;
                r = a, o = e[i = t], i in r ? Object.defineProperty(r, i, {
                    value: o,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
    ...
    var e = function (a) {
            ...
            return a.fn.mmEmulateTransitionEnd = function (t) {
                var r = this, i = !1;
                return a(this).one(e.TRANSITION_END, function () {
                    i = !0
                }), setTimeout(function () {
                    i || e.triggerTransitionEnd(r)
                }, t), this
            }, a.event.special[e.TRANSITION_END] = {
                bindType: t, delegateType: t, handle: function (t) {
                    if (a(t.target).is(this)) return t.handleObj.handler.apply(this, arguments)
                }
            }, e
        }(a = a && a.hasOwnProperty("default") ? a.default : a), r = "metisMenu", i = "metisMenu", o = "." + i, n = a.fn[r],
        s = {toggle: !0, preventDefault: !0, triggerElement: "a", parentTrigger: "li", subMenu: "ul"}, d = {
            SHOW: "show" + o,
            SHOWN: "shown" + o,
            HIDE: "hide" + o,
            HIDDEN: "hidden" + o,
            CLICK_DATA_API: "click" + o + ".data-api"
        }, b = "mm-active", c = "mm-show", l = "mm-collapse", g = "mm-collapsing", h = function () {
            function r(a, e) {
                this.element = a, this.config = t({}, s, e), this.transitioning = null, this.init()
            }

            var o = r.prototype;
            return o.init = function () {
                var t = this, e = this.config;
                a(this.element).addClass("metismenu"), a(this.element).find(e.parentTrigger + "." + b).children(e.triggerElement).attr("aria-expanded", "true"), a(this.element).find(e.parentTrigger + "." + b).parents(e.parentTrigger).addClass(b), a(this.element).find(e.parentTrigger + "." + b).parents(e.parentTrigger).children(e.triggerElement).attr("aria-expanded", "true"), a(this.element).find(e.parentTrigger + "." + b).has(e.subMenu).children(e.subMenu).addClass(l + " " + c), a(this.element).find(e.parentTrigger).not("." + b).has(e.subMenu).children(e.subMenu).addClass(l), a(this.element).find(e.parentTrigger).has(e.subMenu).children(e.triggerElement).on(d.CLICK_DATA_API, function (r) {
                    var i = a(this), o = i.parent(e.parentTrigger),
                        n = o.siblings(e.parentTrigger).children(e.triggerElement), s = o.children(e.subMenu);
                    e.preventDefault && r.preventDefault(), "true" !== i.attr("aria-disabled") && (o.hasClass(b) ? (i.attr("aria-expanded", "false"), t.hide(s)) : (t.show(s), i.attr("aria-expanded", "true"), e.toggle && n.attr("aria-expanded", "false")), e.onTransitionStart && e.onTransitionStart(r))
                })
            }, o.show = function (t) {
                var r = this;
                if (!this.transitioning && !a(t).hasClass(g)) {
                    var i = a(t), o = a.Event(d.SHOW);
                    if (i.trigger(o), !o.isDefaultPrevented()) {
                        if (i.parent(this.config.parentTrigger).addClass(b), this.config.toggle) {
                            var n = i.parent(this.config.parentTrigger).siblings().children(this.config.subMenu + "." + c);
                            this.hide(n)
                        }
                        i.removeClass(l).addClass(g).height(0), this.setTransitioning(!0), i.height(t[0].scrollHeight).one(e.TRANSITION_END, function () {
                            r.config && r.element && (i.removeClass(g).addClass(l + " " + c).height(""), r.setTransitioning(!1), i.trigger(d.SHOWN))
                        }).mmEmulateTransitionEnd(350)
                    }
                }
            }, o.hide = function (t) {
                var r = this;
                if (!this.transitioning && a(t).hasClass(c)) {
                    var i = a(t), o = a.Event(d.HIDE);
                    if (i.trigger(o), !o.isDefaultPrevented()) {
                        i.parent(this.config.parentTrigger).removeClass(b), i.height(i.height())[0].offsetHeight, i.addClass(g).removeClass(l).removeClass(c), this.setTransitioning(!0);
                        var n = function () {
                            r.config && r.element && (r.transitioning && r.config.onTransitionEnd && r.config.onTransitionEnd(), r.setTransitioning(!1), i.trigger(d.HIDDEN), i.removeClass(g).addClass(l))
                        };
                        0 === i.height() || "none" === i.css("display") ? n() : i.height(0).one(e.TRANSITION_END, n).mmEmulateTransitionEnd(350)
                    }
                }
            }, o.setTransitioning = function (a) {
                this.transitioning = a
            }, o.dispose = function () {
                a.removeData(this.element, i), a(this.element).find(this.config.parentTrigger).has(this.config.subMenu).children(this.config.triggerElement).off("click"), this.transitioning = null, this.config = null, this.element = null
            }, r.jQueryInterface = function (e) {
                return this.each(function () {
                    var o = a(this), n = o.data(i), d = t({}, s, o.data(), "object" == typeof e && e ? e : {});
                    if (n || (n = new r(this, d), o.data(i, n)), "string" == typeof e) {
    ...
    return a.fn[r] = h.jQueryInterface, a.fn[r].Constructor = h, a.fn[r].noConflict = function () {
        return a.fn[r] = n, h.jQueryInterface
    }, h
});
...
function dezSettings({
    ...
    this.typography = a || "poppins", this.version = t || "dark", this.layout = e || "vertical", this.navheaderBg = r || "color_1", this.headerBg = i || "color_1", this.sidebarStyle = o || "full", this.sidebarBg = n || "color_1", this.sidebarPosition = s || "static", this.headerPosition = d || "static", this.containerLayout = b || "wide", this.direction = c || "ltr", this.manageTypography(), this.manageVersion(), this.manageLayout(), this.manageNavHeaderBg(), this.manageHeaderBg(), this.manageSidebarStyle(), this.manageSidebarBg(), this.manageSidebarPosition(), this.manageHeaderPosition(), this.manageContainerLayout(), this.manageRtlLayout(), this.manageResponsiveSidebar()
}
...
dezSettings.prototype.manageVersion = function () {
    ...
    switch (this.sidebarStyle) {
        ...
        case"modern":
            ...
            break;
        case"icons-hover":
            body.attr("data-sidebar-style", "icons-hover"), $(".deznav").hover(function () {
    ...
    a < 1200 && (body.attr("data-layout", "vertical"), body.attr("data-container", "wide")), a > 767 && a < 1200 && body.attr("data-sidebar-style", "mini"), a < 768 && body.attr("data-sidebar-style", "overlay")
};
