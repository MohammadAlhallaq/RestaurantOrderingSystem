   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                  ...
                  for (var i = y-3; i < y + 4; i++) {
                      yearPicker += '<div class="year-picker-itemController" data-year="' + i + '">' + i + '</div>';
                  }
                  this.midYear=y;
                  var yearHtml =
              ...
              initButtons: function ()
              {
                 ...
                 this._attachEvent(this.$dtpElement.find('div.year-picker-itemController'), 'click', this._onYearItemClick.bind(this));
              ...
              _onYearAfterClick: function ()
              {
               ...
               refreshYearItems:function () {
                  var curYear=this.currentDate.year(),midYear=this.midYear;
                   ...
                   this.$dtpElement.find(".year-picker-itemController").each(function (i, el) {
