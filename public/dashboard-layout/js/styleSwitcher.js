...
(function($) {
    ...
    sidebarStyleSelect.on('change', function() {
        ...
        body.attr('data-sidebar-style', this.value);
         ...
         if(body.attr('data-sidebar-style') === 'icons-hover') {
