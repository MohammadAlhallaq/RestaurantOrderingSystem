                ...
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form class="form-valide-with-icon needs-validation"
                              action="{{route('add-component')}}" method="post">
                            {{csrf_field()}}
                            <div class="row">
                                ...
                                {{--                                           placeholder="Enter component Price" required--}}
                                {{--                                           value="{{old('componentPrice')}}">--}}
                                {{--                                    <div class="invalid-feedback">--}}
