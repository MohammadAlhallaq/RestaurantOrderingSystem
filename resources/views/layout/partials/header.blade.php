    ...
    ***********************************-->
    <div class="nav-header">
        ...
        <a href="/" class="brand-logo text-center">
                        <span class="logo-lg">
                            <img src="{{URL::asset('dashboard-layout/images/bg-logo.png')}}" alt="" height="25" style="position: relative ;width: 100px;
    height: 100%;">
                            <!-- <span class="logo-lg-text-light">UBold</span> -->
                        </span>
            {{--            <span class="logo-sm" hidden>--}}
            {{--                            <!-- <span class="logo-sm-text-dark">U</span> -->--}}
            {{--                            <img src="{{URL::asset('dashboard-layout/images/bg-logo.png')}}" alt="" height="28" style="width: 70%;--}}
            {{--    height: 100%;">--}}
            {{--                        </span>--}}
        </a>
                    ...
                    <ul class="navbar-nav header-right">
                        ...
                        <li class="nav-item dropdown notification_dropdown">
                            <a class="nav-link  ai-icon" href="javascript:void(0);" role="button"
                               data-bs-toggle="dropdown" data-toggle="dropdown" href="#" role="button"
                               aria-haspopup="false" aria-expanded="false">
                                <img
                                    src="{{ App::getlocale() == 'ar' ? URL::asset('dashboard-layout/images/uae.png') : URL::asset('dashboard-layout/images/usa.png') }}"
                                    alt="lang-image" height="25">
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="javascript:" class="dropdown-item notify-item" onclick="ChangeLang('ar')">
                                    <img src="{{URL::asset('dashboard-layout/images/uae.png')}}" alt="lang-image"
                                         class="mr-1" height="25"> <span class="align-middle">العربية</span>
                                </a>

                                <!-- itemController-->
                                <a href="javascript:" class="dropdown-item notify-item" onclick="ChangeLang('en')">
                                    <img src="{{URL::asset('dashboard-layout/images/usa.png')}}" alt="lang-image"
                                         class="mr-1" height="25"> <span class="align-middle">English</span>
                                </a>
                            </div>
                        </li>


                        @if(auth()->user()->account_type_id == \App\Models\Account::IS_RESTAURANT || auth()->user()->can('show-notifications'))
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0);" role="button"
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3"
                                         style="height:380px;">
                                        <ul class="timeline">
                                            @if(auth()->user()->account_type_id == \App\Models\Account::IS_ADMIN)
                                                    ...
                                                    <li>
                                                        <div class="timeline-panel">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <small
                                                                    class="d-block">{{$notification->created_at}}</small>
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endforeach

                                            @elseif(auth()->user()->account_type_id ==\App\Models\Account::IS_RESTAURANT)
                                    ...
                                    <a class="all-notification" href="{{route('show-notifications')}}">See all
                                        notifications <i
                        ...
                        <li class="nav-item dropdown  header-profile">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                @if(auth()->user()->account_type_id == \App\Models\Account::IS_RESTAURANT)
                                ...
                                @elseif(auth()->user()->account_type_id== \App\Models\Account::IS_ADMIN)
                                    <a href="{{route('update-admin', auth()->id())}}}" class="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary"
                                             width="18" height="18" viewBox="0 0 24 24" fill="none"
                                             stroke="currentColor"
                                             stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                @endif
                                <a href="{{route('log-out')}}" class="dropdown-item ai-icon">
