                    ...
                    @endif
                        <div class="basic-form">
                            <form class="form-valide-with-icon needs-validation"
                                  action="{{route('edit-sales-worker', $sales_worker->id)}}" method="post">
                                {{csrf_field()}}
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control readonly" name="workercode" id="workercode" value="{{$sales_worker->code}}" required>
                                    </div>
                                </div>
