...
@section('content')
  ...
  right: 0;">
    ...
    <div class="form-check custom-checkbox mb-3 col-md-4">
        <label class="form-check-label" for="termsCheckbox">Clicking the Checkbox indicates that you have read and
            agreed to the terms and conditions of Allin1UAE</label>
        <input type="checkbox" class="form-check-input" id="termsCheckbox" name="termsCheckbox"
               required="">
    </div>

    <div class="toolbar toolbar-bottom" role="toolbar" style="text-align: right;">
        <button class="btn btn-primary sw-btn-next submit">Update</button>
    </div>
    ...
    <script>
        $(".submit").click(function (event) {
            ...
            swal({
                ...
                text: "Changing the package will result in losing the remaining period of the current subscription",
                type: "warning",
                showCancelButton: !0,
